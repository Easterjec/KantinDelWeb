...
<!-- End of Sidebar -->
    ...
    <table class="table table-bordered">
        ...
        @foreach ($pesanmakanan as $pesanmakanans)
        <tr>
            <td>{{ $pesanmakanans->id_pesananmakanan }}</td>
            
            <td>{{ $pesanmakanans->tanggal_pemesanan_makanan }}</td>
            <td>{{ $pesanmakanans->total_item }}</td>
            <td>{{ $pesanmakanans->total_pembayaran }}</td>
            <td>{{ $pesanmakanans->nama_penerima }}</td>
            <td>{{ $pesanmakanans->nomor_hp }}</td>
            <td>{{ $pesanmakanans->catatan }}</td>
           
            
            <td>
            <a href="/pesan/Hapus/{{$pesanmakanans->id_pesananmakanan}}" class="btn btn-danger" >Hapus</a>
            </td>
        </tr>
        @endforeach
    </table>
