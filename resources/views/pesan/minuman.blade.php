...
<!-- End of Sidebar -->
    ...
    <table class="table table-bordered">
        ...
        @foreach ($pesanminuman as $pesanminumans)
        <tr>
        <td>{{ $pesanminumans->id_pesananminuman }}</td>
            <td>{{ $pesanminumans->tanggal_pemesanan_minuman }}</td>
            <td>{{ $pesanminumans->total_item }}</td>
            <td>{{ $pesanminumans->total_pembayaran }}</td>
            <td>{{ $pesanminumans->nama_penerima }}</td>
            <td>{{ $pesanminumans->nomor_hp }}</td>
            <td>{{ $pesanminumans->catatan }}</td>
            <td>
            <a href="/pesan/Hapus/{{$pesanminumans->id_pesananminuman}}" class="btn btn-danger" >Hapus</a>
            </td>
        </tr>
        @endforeach
    </table>
