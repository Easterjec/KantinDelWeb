...
<!-- End of Sidebar -->
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Rincian Pemesanan Snack</h1>
                    </div>
    ...
    <table class="table table-bordered">
        ...
        @foreach ($pesansnack as $pesansnacks)
        <tr>
            <td>{{ $pesansnacks->id_pesanansnack }}</td>
            <td>{{ $pesansnacks->tanggal_pemesanan_snack }}</td>
            <td>{{ $pesansnacks->total_item }}</td>
            <td>{{ $pesansnacks->total_pembayaran }}</td>s
            <td>{{ $pesansnacks->nama_penerima }}</td>
            <td>{{ $pesansnacks->nomor_hp }}</td>
            <td>{{ $pesansnacks->catatan }}</td>
            <td>
            <a href="/pesan/Hapus/{{$pesansnacks->id_pesanansnack}}" class="btn btn-danger" >Hapus</a>
            </td>
        </tr>
        @endforeach
    </table>
