            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Snack</h1>
                    </div>
...
<div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <!-- <a class="btn btn-primary" href="{{ asset('home') }}" enctype="multipart/form-data"> Back</a> -->
                <a class="btn btn-success" href="{{ route('snack.create') }}"> Tambah Snack</a>
            </div>
        </div>
    </div>
    ...
    <table class="table table-bordered">
        ...
        <tr>
        <td>{{ $snacks->id_snack }}</td>
            <td>{{ $snacks->nama }}</td>
            <td>{{ $snacks->harga }}</td>
            <td>{{ $snacks->deskripsi }}</td>
            <td>{{ $snacks->stok }}</td>
        
            
            <td>
                <form action="{{ route('snack.destroy',$snacks->id_snack) }}" method="POST">
    
                    <a class="btn btn-primary" href="{{ route('snack.edit',$snacks->id_snack) }}">Edit</a>
