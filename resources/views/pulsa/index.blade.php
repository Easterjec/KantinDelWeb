...
<!-- End of Sidebar -->
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Pulsa</h1>
                    </div>
        ...
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right mb-2">
                ...
                <a class="btn btn-success" href="{{ route('pulsa.create') }}"> Tambah Pulsa</a>
            </div>
        </div>
    </div>
    ...
    <table class="table table-bordered">
        ...
        @foreach ($pulsa as $pulsas)
        <tr>
            <td>{{ $pulsas->id_pulsa }}</td>
            <td>{{ $pulsas->nominal }}</td>
            <td>{{ $pulsas->harga }}</td>
            <td>
                <form action="{{ route('pulsa.destroy',$pulsas->id_pulsa) }}" method="POST">
    
                    <a class="btn btn-primary" href="{{ route('pulsa.edit',$pulsas->id_pulsa) }}">Edit</a>
