...
<!-- End of Sidebar -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <!-- <a class="btn btn-primary" href="{{ asset('home') }}" enctype="multipart/form-data"> Back</a> -->
                <a class="btn btn-success" href="{{ route('minuman.create') }}"> Tambah Barang</a>
            </div>
        </div>
    </div>
    ...
    <table class="table table-bordered">
        ...
        @foreach ($minuman as $minumans)
        <tr>
            <td>{{ $minumans->id_minuman }}</td>
            <td>{{ $minumans->nama }}</td>
            <td>{{ $minumans->harga }}</td>
            <td>{{ $minumans->deskripsi }}</td>
            <td>{{ $minumans->stok }}</td>
    
            <td>
                <form action="{{ route('minuman.destroy',$minumans->id_minuman) }}" method="POST">
    
                    <a class="btn btn-primary" href="{{ route('minuman.edit',$minumans->id_minuman) }}">Edit</a>
